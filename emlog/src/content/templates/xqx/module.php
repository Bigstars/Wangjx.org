...
<?php }?>
<?php
//Gravatar被墙，替换https链接 你也可以修改/lib/function.base.php下getGravatar() 
function getHttpsGravatar($email, $s = 40, $d = 'mm', $g = 'g') {
	$hash = md5($email);
...
function blog_comments($comments){
	...
	<div class="comment" id="comment-<?php echo $comment['cid']; ?>">
		...
		<?php if($isGravatar == 'y'): ?><div class="avatar"><img src="<?php echo getHttpSGravatar($comment['mail']); ?>" /></div><?php endif; ?>
...
function blog_comments_post($logid,$ckname,$ckmail,$ckurl,$verifyCode,$allow_remark){
	...
	<div class="comment-post" id="comment-post">
		...
		<form method="post" name="commentform" action="<?php echo BLOG_URL; ?>index.php?action=addcom" id="commentform">
			...
			<p>
				<input class="info" type="text" name="comname" maxlength="49" value="<?php echo $ckname; ?>" size="22" >
				<label for="author"><small>昵称</small></label>
			</p>
			<p>
				<input class="info" type="text" name="commail"  maxlength="128"  value="<?php echo $ckmail; ?>" size="22" >
				<label for="email"><small>邮件地址 (选填)</small></label>
			</p>
			<p>
				<input class="info" type="text" name="comurl" maxlength="128"  value="<?php echo $ckurl; ?>" size="22" >
				<label for="url"><small>个人主页 (选填)</small></label>
			</p>
			<?php endif; ?>
			<p><textarea name="comment" id="comment" ></textarea></p><!--rows="10" tabindex="4"-->
